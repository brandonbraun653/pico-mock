...
{
    mock().actualCall("gpio_set_irq_enabled").withUnsignedIntParameter("gpio", gpio).withUnsignedIntParameter("event_mask", event_mask).withBoolParameter("enabled", enabled);
}

void gpio_set_irq_enabled_with_callback(uint gpio, uint32_t event_mask, _Bool enabled, gpio_irq_callback_t callback)
{
    mock().actualCall("gpio_set_irq_enabled_with_callback").withUnsignedIntParameter("gpio", gpio).withUnsignedIntParameter("event_mask", event_mask).withBoolParameter("enabled", enabled).withPointerParameter("callback", callback);
}
